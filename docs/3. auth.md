...
<form class="w-full space-y-4" method="POST" action="?/login" use:enhance>
    ...
    <a class="text-sm text-primary-500 hover:text-primary-900" href="auth/forgot-password"
    ...
    <div class="flex flex-col items-start gap-y-2">
        <a class="text-sm text-primary-500 hover:text-primary-900" href="/auth/signup"
            >Create an account</a
        >
    </div>
</form>
